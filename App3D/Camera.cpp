...
Camera::Camera()
{
    ...
    SetLens(0.33f * XM_PI, 800.0f / 600.0f, 1.0f, 1000.0f); //Mess around with farZ values, I think 175.0f is good but in different setting another might be more appropriate
